...
const CONFIG = {
  ...
  music: {
    // File lagu bawaan: "music.mp3" (Tersimpan langsung di web Anda, 100% bebas 403 & pasti bersuara)
    // Anda juga bisa menggantinya dengan memilih file lagu dari folder di Admin Panel!
    audioUrl: "music.mp3",
    
    // Judul & penyanyi yang tampil di pemutar musik
    title: "Aesthetic Lofi Beats",
